        ...
        <div class="col-main-text">
          ...
          @if(isset($hasAccess) && $hasAccess)
              <div style="display: flex; gap: 12px; align-items: center; margin-top: 35px;">
                  ...
                  <a href="{{ route('magz.preview_pdf', ['slug' => $magz->slug]) }}" target="_blank" class="btn-subscribe" style="margin-top: 0; background-color: transparent; color: #111 !important; border: 1.5px solid #111;">PREVIEW</a>
                  @endif
              </div>
          @else
              <div style="display: flex; gap: 12px; align-items: center; margin-top: 35px;">
