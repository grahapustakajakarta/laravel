...
<head>
    ...
    <title>Sign Up — Galeri Buku Jakarta</title>
...
<div class="signin-page">
    ...
    <div class="signin-form-panel">
        ...
        <div class="signin-form-inner">
            ...
            {{-- Judul --}}
            <h1 class="signin-title">Daftar Akun Gratis</h1>
            ...
            {{-- FORM --}}
            <form id="signin-form" action="{{ route('user.signup.post') }}" method="POST">
                @csrf

                {{-- Langkah 1: Full Form --}}
                <div id="step-email">
                    <label class="signin-label" for="nama">Nama Lengkap</label>
                    <input
                        type="text"
                        id="nama"
                        name="nama"
                        class="signin-input {{ $errors->has('nama') ? 'is-invalid' : '' }}"
                        value="{{ old('nama') }}"
                        placeholder=""
                        autocomplete="name"
                        required
                    >
                    @if($errors->has('nama'))
                        <div class="signin-error">{{ $errors->first('nama') }}</div>
                    @endif
                    ...
                    {{-- Langkah 2: Password --}}
                    <div class="signin-pass-group visible" id="pass-group">
                        ...
                        <label class="signin-label" for="password_confirmation" style="margin-top:12px;">Konfirmasi Password</label>
                        <input
                            type="password"
                    ...
                    <button type="submit" id="btn-submit" class="btn-main">Daftar Gratis</button>
                </div>
            </form>
            ...
            <div class="signin-footer-link">
                Sudah punya akun? <a href="{{ route('user.signin') }}">Sign In di sini</a>
                <br><br>
...
<script>
    // Just normal form submit since all fields are shown at once
</script>
</body>
</html>
