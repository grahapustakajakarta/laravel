            ...
            <div class="product-left">
                ...
                <div class="action-buttons">
                    <div class="action-row-2">
                        ...
                        <a href="{{ route('pustaka.preview_pdf', $pustaka->slug) }}" target="_blank" class="btn-pill" style="text-decoration:none; background-color: transparent; border-color: #111; color: #111;">
